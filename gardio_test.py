...
iface = gr.Interface(
    ...
    iface = gr.Interface(
        inputs=[
            # inputs.Textbox(lines=5, label="Input Text"),
            # inputs.Slider(minimum=32, maximum=256, default=64, label="Max Length"),
            # inputs.Slider(minimum=0.0, maximum=1.0, default=0.7, step=0.1, label="Temperature"),
            # inputs.Checkbox(label="Do Sample"),
            # inputs.Checkbox(label="Do Sample"),
        ],
        outputs=gr.HTML(),
